...
const teamMembers = [
  {
    ...
    image: "/placeholders/portrait-nahid.svg",
    social: { linkedin: "#", twitter: "#", github: "#" }
  },
  {
    name: "Sarah Chen",
    role: "Director of Digital Strategy",
    image: "/placeholders/portrait-sarah.svg",
    social: { linkedin: "#", twitter: "#" }
  },
  {
    name: "James Wilson",
    role: "Engineering Lead",
    image: "/placeholders/portrait-james.svg",
    social: { linkedin: "#", github: "#" }
  },
  {
    name: "Elena Rossi",
    role: "UI/UX Architect",
    image: "/placeholders/portrait-elena.svg",
    social: { linkedin: "#", twitter: "#" }
  },
  {
    name: "Marcus Thorne",
    role: "AI Systems Engineer",
    image: "/placeholders/portrait-marcus.svg",
    social: { linkedin: "#", github: "#" }
  },
  {
    name: "Aisha Khan",
    role: "Product Strategist",
    image: "/placeholders/portrait-aisha.svg",
    social: { linkedin: "#", twitter: "#" }
  }
];
...
export default function TeamPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0A0A0F] pt-32 pb-24 relative overflow-hidden selection:bg-brand-primary/30">
      <Navbar />
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 font-sans">
        ...
        <div className="mb-20 md:mb-32 text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white mb-6 uppercase tracking-tighter italic leading-none">
              The <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary via-[#8A83FB] to-brand-secondary">Architects</span>
            </h1>
            <p className="text-base md:text-lg text-white/40 font-medium tracking-wide uppercase">
        ...
        >
          ...
          <h2 className="text-3xl md:text-6xl font-black text-white mb-6 md:mb-8 uppercase tracking-tighter italic relative z-10">
            Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-primary to-brand-secondary">Core.</span>
          </h2>
          <p className="text-lg md:text-xl text-white/40 mb-8 md:mb-12 max-w-2xl mx-auto font-medium relative z-10">
...
function TeamCard({ member }: { member: any }) {
  return (
    <div className="group relative">
      <GlowCard className="p-0 overflow-hidden bg-white/[0.02] border-white/[0.05] backdrop-blur-3xl rounded-[24px] group-hover:bg-white/[0.04] transition-all duration-500">
        ...
        <div className="relative aspect-[3/4] w-full overflow-hidden grayscale group-hover:grayscale-0 transition-all duration-[800ms]">
          ...
          {/* Zig-Zag Watermark */}
          <ZigZag className="absolute bottom-6 right-6 w-12 h-3 text-white/10 group-hover:text-brand-primary/30 transition-colors duration-500" />
          ...
          <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500 translate-y-4 group-hover:translate-y-0">
            {member.social.linkedin && (
              <a href={member.social.linkedin} className="w-10 h-10 rounded-full glass flex items-center justify-center text-white hover:bg-brand-primary transition-all">
                <Linkedin size={18} />
              </a>
            )}
            {member.social.twitter && (
              <a href={member.social.twitter} className="w-10 h-10 rounded-full glass flex items-center justify-center text-white hover:bg-brand-primary transition-all">
                <Twitter size={18} />
              </a>
            )}
            {member.social.github && (
              <a href={member.social.github} className="w-10 h-10 rounded-full glass flex items-center justify-center text-white hover:bg-brand-primary transition-all">
                <Github size={18} />
              </a>
            )}
          </div>
        ...
        <div className="p-8 text-center relative z-10">
          ...
          <h3 className="text-2xl font-bold text-white mb-2 uppercase tracking-tight italic">{member.name}</h3>
